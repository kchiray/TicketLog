...
namespace TicketLog.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Emails,NewApplicaitons,ToDo,YearToDate")] Statistic statistic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Emails,NewApplicaitons,ToDo,YearToDate")] Statistic statistic)
        {
            if (id != statistic.Id)
            {
                return NotFound();
